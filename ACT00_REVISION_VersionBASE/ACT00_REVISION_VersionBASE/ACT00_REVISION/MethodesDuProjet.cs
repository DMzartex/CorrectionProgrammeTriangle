...
{ // écrire les signatures des procédures et fonctions...
    class MethodesDuProjet
    {
        ...
        public bool TriangleRectangle(double a, double b, double c, ref string methode)
        {
            bool ok = false;
        ...
        public bool Triangle(double a, double b, double c, ref string methode)
        {
            bool ok = false;
        ...
        public bool Isocele(double a, double b, double c, ref string methode)
        {
            bool ok = false;
        ...
        public bool Equi(double a, double b, double c, ref string methode)
        {
            bool ok = false;
            if ((a == b) && (a == c))
            {
